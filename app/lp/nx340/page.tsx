...
const BOAT = {
  ...
  description:
    "A NX 340 Sport Coupé combina sofisticação, performance e conforto em uma embarcação pensada para transformar cada saída no mar em uma experiência exclusiva. Com design imponente, espaços amplos e acabamento premium, ela entrega o equilíbrio perfeito entre lazer, elegância e liberdade para aproveitar o melhor de Ubatuba.",
  highlights: [
  ...
  specs: [
    ...
    { label: "Tanque Combustível", value: "450L" },
  ],
  images: {
