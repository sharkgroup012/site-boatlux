...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/boatlux.litoralnortesp",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/boatlux.litoralnortesp",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@boatluxlitoralnortesp9068",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/boatlux-litoral-norte-sp",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-cream-500 text-sm leading-relaxed max-w-xs">
              A maior empresa de cotas náuticas do Brasil. Navegue com
              inteligência e exclusividade no Litoral Norte Paulista.
            </p>
            <div className="flex items-center gap-3 pt-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 rounded-full border border-navy-600 flex items-center justify-center text-cream-500 hover:text-gold-500 hover:border-gold-500 transition-colors"
                >
                  {s.icon}
                </a>
              ))}
          ...
          {/* Links */}
          <div>
            <h3 className="text-gold-500 text-xs font-semibold uppercase tracking-widest mb-4">
              Navegação
            </h3>
